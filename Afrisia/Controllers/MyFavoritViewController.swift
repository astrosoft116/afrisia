...
class MyFavoritViewController: BaseViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func getMyFavorits () {
        ...
        WebService.getMyFavorits(userId: userId!) { (result, error) in
